...
const promoSlides = [
  {
    icon: Gift,
    eyebrow: 'Voucher nổi bật',
    title: 'Giảm 20% cho suất chiếu buổi tối',
    description: 'Ưu đãi được cập nhật theo chiến dịch khuyến mãi đang hoạt động.',
    href: '/promotions',
    action: 'Xem ưu đãi',
  },
  {
    ...
    title: 'Đặt 2 vé nhận ưu đãi bắp nước',
    description: 'Combo được đề xuất để khách hàng chọn nhanh khi đặt vé.',
    href: '/movies?status=now-showing',
    action: 'Đặt vé',
  },
  {
    icon: Sparkles,
    eyebrow: 'Suất chiếu nổi bật',
    title: 'Mở bán sớm cho phim hot cuối tuần',
    description: 'Cập nhật các suất chiếu đáng chú ý để khách hàng dễ theo dõi.',
    href: '/schedule',
    action: 'Xem lịch',
  },
];
